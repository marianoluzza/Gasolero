...
//
void
ImpresorFiscalP715::DatosCliente (	const std::string &RazonSocial,
...
{
	// printf ("Comando DatosCliente ejecutado en P715\n");
...
ImpresorFiscalP715::AbrirDNFH (DocumentosNoFiscalesHomologados Tipo, const std::string &Nro) throw (Excepcion)
{
	...
	switch (Tipo)
	{
		case TICKET_NOTA_CREDITO_A:
			Tipo = NOTA_CREDITO_A;
			break;

		case TICKET_NOTA_CREDITO_B:
		default:
			Tipo = NOTA_CREDITO_B;
			break;
	}
