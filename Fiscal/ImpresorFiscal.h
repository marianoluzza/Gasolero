...
public:
	...
	enum EstadosImpresor						// Bit	   Máscara
	{
		...
		ESTADO_IMPRESOR_CAJON_ABIERTO			= 14,	// 0x4000,
	...
	enum EstadosFiscal							// Bit	   Máscara
    {
		...
		ESTADO_IMPRESOR_OR_LOGICO_0_8			= 15	// 0x8000,
    };
	...
	enum TiposDeDocumento
	{
		...
		D_NONE						=	0xFF	// Documento desconocido.
    };

	enum DocumentosFiscales
	{
		TICKET_FACTURA_A			=	'A',	// Ticket Factura A
		TICKET_FACTURA_B			=	'B',	// Ticket Factura B/C
		FACTURA_A					=	'0',	// Factura A
		FACTURA_B					=	'1',	// Factura B/C
		TICKET_NOTA_DEBITO_A		=	'2',	// Nota de Débito A
		TICKET_NOTA_DEBITO_B		=	'3',	// Nota de Débito B/C
		NOTA_DEBITO_A				=	'D',	// Nota de Débito A
		NOTA_DEBITO_B				=	'E',	// Nota de Débito B/C
		RECIBO_A					=	'a',	// Recibo A
		RECIBO_B					=	'b',	// Recibo B/C
		TICKET_C					= 	'T'		// Ticket B/C
	};
	...
	enum DocumentosNoFiscalesHomologados
	{
		...
		TICKET_NOTA_CREDITO_A		=	'4',	// Ticket Nota de Crédito A
		TICKET_NOTA_CREDITO_B		=	'5',	// Ticket Nota de Crédito B/C
		NOTA_CREDITO_A				=	'R',	// Nota de Crédito A
		NOTA_CREDITO_B				=	'S',	// Nota de Crédito B/C
		REMITO						=	'r',	// Remito
		TICKET_RECIBO_X				=	'6',	// Ticket Recibo X
		RECIBO_X					=	'x',	// Recibo X
		ORDEN_SALIDA				=	's',	// Orden de Salida
		RESUMEN_CUENTA				=	't',	// Resumen de Cuenta
		CARGO_HABITACION			=	'U',	// Cargo a la Habitación
	...
	virtual void ConfigurarControladorCompleto (
							...
							const NumerosDeCopias *NumeroDeCopiasMaximo,
	...
	double ImprimirPago (const std::string &Texto, double Monto) throw (Excepcion);
	...
	virtual void ImprimirInfoEnDNFH (const unsigned IDCampo, const std::string &Texto) throw (Excepcion);
...
//		CMD_STATUS_PJL						= 0x2b,	// Status propio       (HP1200) ...
...
//		CMD_SET_CONFIG_PAGE					= 0x74,	// Setear  conf. hoja  (HP1200) ...
//		CMD_GET_CONFIG_PAGE					= 0x75,	// Obtener conf. hoja  (HP1200) ...
...
// Métodos
	...
	bool IndicadorDeDecumentoPrevioCancelado () throw(Excepcion);
