namespace Gasolero
{
	partial class LVVisor
	{
		...
		private void InitializeComponent()
		{
			...
			// bAjustar
			// 
			this.bAjustar.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.bAjustar.Location = new System.Drawing.Point(81, 291);
			this.bAjustar.Name = "bAjustar";
			this.bAjustar.Size = new System.Drawing.Size(75, 23);
			this.bAjustar.TabIndex = 2;
			this.bAjustar.Text = "Ajustar";
			this.bAjustar.UseVisualStyleBackColor = true;
			this.bAjustar.Visible = false;
			...
			this.Name = "LVVisor";
			this.Text = "Planilla";
			this.Load += new System.EventHandler(this.LVVisor_Load);
